# ===================== PROFESSOR TABLE: alpha_capm_12m (INFLOW t+1, t REGRESSORS) =====================
# PURPOSE:
...
#   - Dependent variable = inflow at t+1
...
dt0[, inflow_t := pmax(flow_dar_t, 0)]

# Inflow at t+1 = dependent variable
dt0[, inflow_tp1 := shift(inflow_t, 1L, type = "lead"), by = crsp_fundno]
...
run_professor_table <- function(dtR_in, dtI_in, dtC_in, out_subdir) {
  ...
  notes_txt <- paste0(
    ...
    "Inflow is defined as the positive part of Darendeli flow, i.e. max(Darendeli flow, 0), ",
  ...
  writeLines(
    ...
    con = file.path(OUT_DIR_RUN, "professor_table_alpha_capm_12m_inflow_tplus1_classFE.html")
  )
  ...
  modelsummary(
    ...
    output = file.path(OUT_DIR_RUN, "professor_table_alpha_capm_12m_inflow_tplus1_classFE.tex")
  )
  ...
  fwrite(
    csv_out,
    file = file.path(OUT_DIR_RUN, "professor_table_alpha_capm_12m_inflow_tplus1_classFE.csv")
  )
  ...
  saveWorkbook(
    wb,
    file.path(OUT_DIR_RUN, "professor_table_alpha_capm_12m_inflow_tplus1_classFE.xlsx"),
    overwrite = TRUE
  )
  ...
  cat("Output folder:\n", OUT_DIR_RUN, "\n\n")
  cat("Files created:\n")
  cat(" - professor_table_alpha_capm_12m_inflow_tplus1_classFE.html\n")
  cat(" - professor_table_alpha_capm_12m_inflow_tplus1_classFE.tex\n")
  cat(" - professor_table_alpha_capm_12m_inflow_tplus1_classFE.xlsx\n")
  cat(" - professor_table_alpha_capm_12m_inflow_tplus1_classFE.csv\n\n")
